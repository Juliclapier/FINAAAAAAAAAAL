...
$('#compra').click(function(){
  ...
  let aux2=`<p class="text-center" style="font-size:50px">Gracias por elegirnos ya enviamos tu factura y datos de la compra a <strong>${aux}</strong></p>
  <div>
...
/*FUNCION PARA MENSAJE VACIO CARRITO Y MENSAJE*/
